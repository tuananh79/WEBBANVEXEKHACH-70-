...
<div class="row justify-content-md-center">
		...
		<div class="bg-light p-5 rounded">
			...
			<form:form class="row g-3" modelAttribute="chuyen"
				action="admin/Chuyen.htm">
				<div class="col-md-4">
				<label for="exampleFormControlInput1" class="form-label">Mã Chuyến(Mặc định)</label>
				<form:input path="chuyen_id" type="text" class="form-control"
					id="exampleFormControlInput1" 
					placeholder="Vui lòng nhập mã chuyến" />
					</div>
					<div class="col-md-4">
				<label for="exampleFormControlInput1" class="form-label">Mã xe</label>
				<form:input path="xe.xe_id" type="text" class="form-control"
					id="exampleFormControlInput1" 
					placeholder="Vui lòng nhập mã xe" />
					</div>
					<div class="col-md-4">
				<label for="exampleFormControlInput1" class="form-label">Mã Tài Xế</label>
				<form:input path="taixe.taixe_id" type="text" class="form-control"
					id="exampleFormControlInput1" 
					placeholder="Vui lòng nhập tài xế" />
					</div>
				<div class="col-md-4">
					<label for="exampleFormControlInput1" class="form-label">Ngày</label>
					<form:input path="ngay" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập ngày khởi hành" />
				</div>
	<div class="col-md-4">
					<label for="exampleFormControlInput1" class="form-label">Tên Chuyến</label>
					<form:input path="tenchuyen" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập ngày khởi hành" />
				</div>

				<div class="col-md-4">
					<label for="exampleFormControlInput1" class="form-label">Giá</label>
					<form:input path="gia" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập giá vé" />
				</div>
				<div class="col-md-4">
					<label for="exampleFormControlInput1" class="form-label">Giờ</label>
					<form:input path="gio" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập giờ xuất phát" />
				</div>
				<div class="col-md-4">
					<label for="exampleFormControlInput1" class="form-label">Số hành khách</label>
					<form:input path="soluongve" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập số hành khách hiện tại" />
				</div>
				<div class="col-md-4">
					...
					<form:input path="trangthai" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập trạng thái chuyến" />
				</div>
				<div class="col-md-4">
					<label for="exampleFormControlInput1" class="form-label">Khuyến Mãi(nếu có)</label>
					<form:input path="khuyenmai" type="text" class="form-control"
						id="exampleFormControlInput1"
						placeholder="Vui lòng nhập khuyến mãi" />
				</div>
...
<div class="bg-light p-5 rounded">
			...
			<c:url value="admin/Chuyen.htm" var="pagedLink">
			...
			<table class="table">
				<thead>
					<tr>
						...
						<th scope="col">Ngày Khởi Hành</th>
						<th scope="col">Tên Chuyến</th>
						<th scope="col">Giá</th>
						<th scope="col">Giờ</th>
						<th scope="col">Số Lượng Vé</th>
