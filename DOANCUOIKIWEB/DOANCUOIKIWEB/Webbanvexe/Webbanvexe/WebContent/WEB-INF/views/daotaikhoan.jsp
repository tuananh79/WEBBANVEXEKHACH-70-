...
<div class="bg-light p-5 rounded">
			...
			<c:url value="daotaikhoan.htm" var="pagedLink">
				...
				<tbody id="table_xes">
					<c:forEach var="tk" items="${pagedListHolder.pageList}">
						...
						<tr>
							...
							<td><a href="daotaikhoan/${tk.taikhoan_id}.htm?linkEdit"><img
									width="50" height="40"
									src="<c:url value="/resources/images/edit.png"/>"></a></td>
							<td><a name="btnDelete"
								href="daotaikhoan/${tk.taikhoan_id}.htm?linkDelete"
